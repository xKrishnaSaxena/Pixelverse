...
//           const message2 = parsedData.payload.message;
...
//           const currentUsers = RoomManager.getInstance().rooms.get(
//             this.spaceId!
//           );
//           const nearbyUsers = currentUsers?.filter((u) => {
//             const dx = Math.abs(u.x - this.x);
//             const dy = Math.abs(u.y - this.y);
//             return dx <= 2 && dy <= 2 && u.id !== this.id;
//           });
